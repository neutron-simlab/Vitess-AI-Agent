...
class SupervisorConfig(BaseModel):
    ...
    # Note: Welcome messages are generated by the LLM routing node (greeting_message field)
...
def create_routing_decision_model(module_names: List[str]) -> Type[BaseModel]:
    ...
    field_definitions = {
        ...
        'action': (
            ...
            Field(
                description=(
                    "Action type: 'route_to_module' to route to a module, "
                    "'route_to_simulation' to route to simulation"
                ),
